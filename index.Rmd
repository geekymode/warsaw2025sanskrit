...
This appears to be a passage from the Muṇḍaka Upaniṣad (1.1.4-5), where it discusses the two types of knowledge (vidyā) - the lower knowledge (aparā vidyā) consisting of the Vedas and their auxiliary sciences, and the higher knowledge (parā vidyā) which is Imperishable. 
...
The final section is a profound passage from the Bhagavad Gita (Chapter 13, verses 8-12 )^[https://shlokam.org/bhagavad-gita/13-8/], where Krishna describes (to Arjuna) the qualities of true knowledge (jnana). Here's the translation:
